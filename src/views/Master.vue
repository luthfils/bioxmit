                            ...
                            <div class="row align-items-center gx-6 gy-6">
                                <div class="col-lg-6 text-md-start">
                                    ...
                                    <div class="emphasis-title bottommargin-sm">
                                        ...
                                        <p class="opmargin-sm mb-0 fc-muted animate__animated animate__fadeInUp animate__delay-400ms">
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="row gy-4">
                                            <div class="col-xl-6 animate__animated animate__fadeInUp animate__delay-500ms">
                                                <div class="d-flex">
                                            ...
                                            <div class="col-xl-6 animate__animated animate__fadeInUp animate__delay-600ms">
                                                <div class="d-flex">
                                                    <div class="me-4 fc-primary">
                                                        <div class="rounded-icon d-flex rounded-14 align-items-center justify-content-center">
                                    ...
                                    <a href="register.html">
                                        <button class="button button-large button-circle fw-medium animate__animated animate__fadeInUp animate__delay-700ms">Register Now</button>
                                    </a>
                                    <a href="#" data-scrollto="#section-about" data-easing="easeInOutExpo">
                                        <button class="button button-large button-border button-circle fw-medium animate__animated animate__fadeInUp animate__delay-800ms">Contact Us</button>
                                    </a>
